...
var _SettingsClient_instances, _SettingsClient_metadata_get, _SettingsClient_plugin_get;
...
_SettingsClient_instances = new WeakSet(), _SettingsClient_metadata_get = function _SettingsClient_metadata_get() {
    return context.metadata;
}, _SettingsClient_plugin_get = function _SettingsClient_plugin_get() {
    return getDevvitConfig().use(SettingsDefinition);
};
