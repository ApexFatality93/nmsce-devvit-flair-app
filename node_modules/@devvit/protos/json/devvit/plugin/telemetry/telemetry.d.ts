...
export type JourneyProgressRequest = {
    /**
     * Unique identifier for the journey.
     * Example: "journey_1234567890"
     */
...
export type JourneyInteractionRequest = {
    /**
     * Unique identifier for the journey.
     * Example: "journey_1234567890"
     */
...
export type JourneyInteractionResponse = {
    receipt?: JourneyReceipt | undefined;
};
...
export type EndJourneyResponse = {
    receipt?: JourneyReceipt | undefined;
};
/** Request to signal that the app is ready. */
export type AppReadyRequest = {
    /**
