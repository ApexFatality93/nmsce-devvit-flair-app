        ...
        try {
            ...
            if (appInfo.appSourceBuffer) {
                ...
                if (appInfo.appSourceBuffer.byteLength > LARGE_BUNDLE_WARNING_THRESHOLD) {
                    ...
                    __classPrivateFieldGet(this, _AppVersionUploader_cmd, "f").warn('This is a large file, it may take a couple minutes to upload.');
                }
                try {
                    ...
                    __classPrivateFieldGet(this, _AppVersionUploader_cmd, "f").error(msg);
                }
                ux.action.stop('Done');
            }
